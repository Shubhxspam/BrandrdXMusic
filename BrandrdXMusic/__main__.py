...
async def init():
    ...
    await Hotty.start()
    try:
        await Hotty.stream_call("https://files.catbox.moe/xpel5b.mp4")
    ...
    LOGGER("BrandrdXMusic").info(
        "ᴅʀᴏᴘ ʏᴏᴜʀ ɢɪʀʟꜰʀɪᴇɴᴅ'ꜱ ɴᴜᴍʙᴇʀ ᴀᴛ @Demonxcoder ᴊᴏɪɴ @secretchamber1227 , @Mrshubh_1227 ꜰᴏʀ ᴀɴʏ ɪꜱꜱᴜᴇꜱ"
    )
    await idle()
    await app.stop()
    await userbot.stop()
